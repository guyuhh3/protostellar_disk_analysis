...
working_dir_name = os.path.join(current_dir, 'RADMC_inputs_snapshot_' + inputs.snap)
...
ad = ds.all_data()
print("Gas density stats:")
print("  Min:", ad[('PartType0', 'Density')].min().in_units('g/cm**3'))
print("  Max:", ad[('PartType0', 'Density')].max().in_units('g/cm**3'))
print("  Mean:", ad[('PartType0', 'Density')].mean().in_units('g/cm**3'))

dust_density = ad[('PartType0', 'DustDensity')].in_units('g/cm**3')
print("Dust density stats:")
print("  Min:", dust_density.min())
print("  Max:", dust_density.max())
print("Mean:", dust_density.mean().in_units('g/cm**3'))
